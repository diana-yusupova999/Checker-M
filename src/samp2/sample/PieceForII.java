...
public class PieceForII implements Piece {

    PieceForII(Piece piece) {
    ...
    @Override
    protected PieceForII clone() throws CloneNotSupportedException {
        PieceForII newPieceForII = (PieceForII) super.clone();
    ...
    public PieceForII(PieceType type, int x, int y) {
        this.type = type;
        this.y = y;
        this.x = x;
        rank = PieceRank.PAWN;
